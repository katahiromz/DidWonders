...
This is redirector by Katayama Hirofumi MZ.

redirector is a Win32 command line tool to redirect 
standard input, standard output and standard error output.
It works on Windows 95/98/Me/2000/XP/Vista/7.

Usage: redirector input_file output_file error_file program [parameters]
